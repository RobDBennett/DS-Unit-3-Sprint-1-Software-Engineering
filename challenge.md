...
* I appreciate comments and layout to code. But I think what I appreciate the most is when people remove their test code from the final products. All the commented out things, or the items that just weren't necessary to accomplish what you want.
* What I try to do when I review code, and I appreciate when others do for me, is reference line numbers when they are discussing things. If the review spreads out over many files, have a master review file that references the lines and files specifically. 

* Containers could help a great deal with cutting down on the computational power spent to generate multiple virtual enviornments. Containers such as Docker also help multiple people work on the same instance of a thing, which is pretty neat. While I was able to get Docker to work from the command line, I haven't been able to collaborate meaningfully with others yet. I'm excited for potential future pairings, though. 
